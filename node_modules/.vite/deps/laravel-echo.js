...
var _r = class _r {
  ...
  csrfToken() {
    var _a, _b;
    return typeof window < "u" && ((_a = window.Laravel) == null ? void 0 : _a.csrfToken) ? window.Laravel.csrfToken : this.options.csrfToken ? this.options.csrfToken : typeof document < "u" && typeof document.querySelector == "function" ? ((_b = document.querySelector('meta[name="csrf-token"]')) == null ? void 0 : _b.getAttribute("content")) ?? null : null;
  }
};
_r._defaultOptions = {
  auth: {
...
var S = class {
  ...
  registerInterceptors() {
    typeof Vue < "u" && (Vue == null ? void 0 : Vue.http) && this.registerVueRequestInterceptor(), typeof axios == "function" && this.registerAxiosRequestInterceptor(), typeof jQuery == "function" && this.registerjQueryAjaxSetup(), typeof Turbo == "object" && this.registerTurboRequestInterceptor();
  }
  /**
