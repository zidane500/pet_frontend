...
const SUCCESS_STORIES = [
  ...
  },
  {
    id: "s3",
    name: "Bella",
    adoptedBy: "Famille Cherif",
    date: "Mars 2026",
    avatar:
      "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=60&h=60&fit=crop",
    species: "Chatte",
  },
];
...
const VOLUNTEERS = [
  {
    ...
    role: "Coordinatrice",
    avatar:
      "https://images.unsplash.com/photo-1494790108755-2616b612b902?w=80&h=80&fit=crop&crop=face",
  },
  {
    id: "v2",
    name: "Youssef K.",
...
export function ShelterProfilePage({
  ...
  const capacityPct = Math.round(
    (SHELTER.currentAnimals / SHELTER.capacity) * 100,
  );
    ...
    >
      ...
      <div className="px-4 mb-4">
        <div className="grid grid-cols-4 gap-2">
          {[
            {
              value: SHELTER.animalsHelped.toLocaleString(),
              label: "Accueillis",
            },
              ...
              {AVAILABLE_ANIMALS.map((animal) => (
                ...
                >
                  ...
                  <div className="p-3">
                    ...
                    <button
                      onClick={() =>
                        onNavigate("pet-detail", { id: animal.id })
                      }
            ...
            >
              ...
              <div className="glass-card p-4 rounded-2xl">
                <div className="flex items-center justify-between text-sm mb-2">
                  ...
                  <span className="text-[var(--pc-primary)] font-bold">
                    680 / 1000 DT
                  </span>
                </div>
                ...
                <div className="text-xs text-[var(--pc-text-secondary)]">
                  68% de l'objectif atteint ce mois
                </div>
              </div>
                  ...
                  {RECENT_DONORS.map((d, i) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[var(--pc-text-primary)]">
                          {d.name}
                        </span>
                      </div>
                      <div className="text-right">
                        <div className="font-semibold text-[var(--pc-accent)]">
                          {d.amount}
                        </div>
                        <div className="text-xs text-[var(--pc-text-secondary)]">
                          {d.date}
